...
def load_data(city, month, day):
    ...
    #convert the Start Time and End Time  datetime yyyy-mm-dd
    df['Start Time'] = pd.to_datetime(df['Start Time'])
    df['End Time'] = pd.to_datetime(df['End Time'])
    #Add new column months  
